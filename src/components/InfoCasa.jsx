import { Wifi, Home, Snowflake, MapPin, ShieldCheck, Waves, BedDouble, Tv, Accessibility } from 'lucide-react';

export default function InfoCasa() {
  // Lista de comodidades atualizada com os novos boxes solicitados
  const comodidades = [
    { icone: <Home className="w-5 h-5 text-onda-casa" />, texto: "Acomoda até 10 pessoas confortavelmente" },
    ...
    { icone: <Accessibility className="w-5 h-5 text-onda-casa" />, texto: "Casa térrea com acessibilidade para PCD" },
  ];
    ...
    <div className="w-full max-w-xl p-6 bg-areia-clara rounded-2xl shadow-lg border border-verde-claro flex flex-col gap-6">
      ...
      <div className="border-t border-verde-claro pt-4">
        ...
        <ul className="list-disc list-inside text-sm text-slate-700 space-y-2 pl-1 leading-relaxed">
          ...
          <li>
            <strong className="text-verde-casa">Mar calmo:</strong> Praia de águas tranquilas, mornas e seguras, excelente para relaxar, nadar e aproveitar com crianças sem preocupações com ondas fortes.
          </li>
          <li>
            <strong className="text-verde-casa">Praticidade ao redor:</strong> Ampla conveniência a poucos minutos, com mercados, padarias e excelentes restaurantes.
          </li>
          <li>
            <strong className="text-verde-casa">Tranquilidade garantida:</strong> Condomínio estritamente residencial, seguro e monitorado para o seu total sossego.
          </li>
        </ul>
      </div>
    </div>
